...
class CardUrlSpider(scrapy.Spider):
    ...
    def parse_vacancy_card(self, response):
        yield {
            ...
            'salary': response.xpath("/html[@class='desktop']/body[@class=' s-friendly xs-friendly']/div["
                                     "@id='HH-React-Root']/div/div[@class='HH-MainContent "
                                     "HH-Supernova-MainContent']/div[@class='main-content']/div["
                                     "@class='bloko-columns-wrapper']/div[@class='row-content']/div["
                                     "@class='bloko-text bloko-text_large']/div[@class='bloko-columns-row']/div["
                                     ...
                                     "bloko-header-section-2_lite']").extract()[0].replace('<span data-qa="vacancy-salary-compensation-type-net" class="bloko-header-section-2 bloko-header-section-2_lite">от <!-- -->', '').replace('<!-- -->', '').replace('.<span class="vacancy-salary-compensation-type"> на руки</span></span>', ''),
